...
class FantraxPlayerMapper:
    ...
    def from_json(self, dto: Mapping[str, Any], player_id:int) -> FantraxPlayer:
        ...
        def _parse_player_team_name(player:FantraxPlayer, table: Dict[str, Any]) -> None:
    ...
    def get_player_recent_gameweek_stats(self, dto: Mapping[str, Any], player:FantraxPlayer) -> List[PlayerGameweekStats]:
                    ...
                    for gameweek_row in gameweek_rows[:MAX_RECENT_GAMEWEEKS]:
                        ...
                        player_recent_gameweek_stats.append(
                            PlayerGameweekStats(
                                ...
                                points=Decimal(gameweek_row['cells'][stat_header_name_to_index[FANTRAX_PLAYER_RECENT_GAMES_TABLE_HEADER_NAME_POINTS]]['content']) if stat_header_name_to_index[FANTRAX_PLAYER_RECENT_GAMES_TABLE_HEADER_NAME_POINTS] is not None else Decimal(0),
