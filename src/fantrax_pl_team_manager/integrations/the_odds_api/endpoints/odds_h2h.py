...
def get_odds_h2h(http: HttpClient, mapper: Mapper[BookingOddsHeadToHead]) -> List[BookingOddsHeadToHead]:
    """Get the odds for a head to head match.

    Returns:
        List[BookingOddsHeadToHead]: Booking odds for a head to head match
    """
